...
export function CreateProject() {
  ...
  async function createProject() {
    ...
    setStatus('saving')
    const response = await fetch('/api/projects', { method: 'POST', headers: { 'content-type': 'application/json' }, body: JSON.stringify({ title, concept: idea, format: kind, durationSeconds: parseDuration(duration) }) })
