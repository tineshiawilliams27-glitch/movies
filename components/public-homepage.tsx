    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto grid max-w-7xl gap-12 px-6 pb-20 pt-16 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:px-10 lg:pt-24">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-border bg-card p-3 shadow-2xl shadow-accent/5">
          <div className="rounded-2xl border border-border bg-background p-5"><div className="flex items-center justify-between border-b border-border pb-4"><div><p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Project workspace</p><h2 className="mt-1 text-xl font-semibold">The Last Light</h2></div><span className="rounded-full bg-accent/15 px-3 py-1 text-xs text-accent">Draft</span></div><div className="mt-5 aspect-video rounded-2xl bg-gradient-to-br from-muted via-card to-accent/20 p-4"><div className="flex h-full items-end justify-between rounded-xl border border-border/70 bg-background/40 p-4"><div><p className="text-xs text-muted-foreground">Scene 08</p><p className="mt-1 max-w-[220px] text-lg font-medium">A secret surfaces beneath the family archive.</p></div><span className="rounded-full border border-border bg-background/70 px-2 py-1 text-xs text-muted-foreground">00:42</span></div></div><div className="mt-5 grid grid-cols-3 gap-3"><div className="rounded-xl border border-border p-3"><Layers3 size={16} className="text-accent" /><p className="mt-3 text-lg font-semibold">24</p><p className="text-xs text-muted-foreground">Scenes</p></div><div className="rounded-xl border border-border p-3"><Film size={16} className="text-accent" /><p className="mt-3 text-lg font-semibold">12:48</p><p className="text-xs text-muted-foreground">Timeline</p></div><div className="rounded-xl border border-border p-3"><Sparkles size={16} className="text-accent" /><p className="mt-3 text-lg font-semibold">Ready</p><p className="text-xs text-muted-foreground">Workspace</p></div></div></div>
        </div>
      </section>
