...
export function CharacterManager({ projectId }: { projectId: string }) {
  ...
  async function saveCharacter() {
    if (!active) return
    setSaving(true)
    await fetch(`/api/projects/${projectId}/characters/${active.id}`, { method: 'PATCH', headers: { 'content-type': 'application/json' }, body: JSON.stringify(active) })
    setSaving(false)
  }
