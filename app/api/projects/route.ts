...
const projectSchema = z.object({ title: z.string().trim().min(1).max(200), concept: z.string().max(20000).default(''), format: z.string().max(80).default('Story'), durationSeconds: z.number().nonnegative().optional() })
